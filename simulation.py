    ...
    for i in range(0, 17):
        ...
        for j in range(1, 290):
            if j in models:
                ...
                probability.append(-1)
        probabilities[i] = probability
        print "Image " + str(i + 1) + " processed for game " + str(game_id)
...
def play_object(cursor, object_id, tags, gameID, all_games, objectlist, con, Pi):
    ...
    for item in xrange(0, 17):
        ...
        #pO is a list of probabilities. Index corresponds to object id, value corresponds to probability [0, 1]
...
def play_round(cursor, tags, gameID, all_games, objectlist, con):
    ...
    for OBJECT_WE_PLAY in obj_ids:
        ...
        print "WOWOW PLAYING OBJECT " + str(OBJECT_WE_PLAY)
...
def play_game(cursor, con):
    ...
    # Get a list of object names from db
    ...
    for gameID in range(16,31):
        ...
        print "STARTING GAME " + str(gameID)
        start = time.time()
        ...
        print "WO"*200+"W"
        print "COMPLETED GAME " + str(gameID)
        print "IT ONlY TOOK %d SECONDS!!!" % int(end - start)
